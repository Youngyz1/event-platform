...
export default function SettingsClient({
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <form onSubmit={saveAccount} className="rounded-xl border border-zinc-200/80 bg-white p-4 shadow-sm sm:rounded-2xl sm:p-6">
        <h2 className="mb-4 text-sm font-black tracking-tight text-zinc-950 sm:mb-5 sm:text-base">Account Settings</h2>
        <div className="grid gap-5">
          <div>
            <label className="mb-1.5 block text-[10px] font-black uppercase tracking-wide text-zinc-500 sm:text-xs">Display Name</label>
            <input
              type="text"
              value={displayName}
              onChange={(e) => setDisplayName(e.target.value)}
              className="w-full rounded-lg border border-zinc-200 px-3 py-2.5 text-sm font-semibold outline-none focus:border-orange-500 sm:rounded-xl sm:px-4 sm:py-3"
            />
          </div>
        </div>
        <div className="mt-4 flex flex-wrap items-center gap-2 sm:mt-5 sm:gap-3">
          <button
            ...
            className="rounded-lg bg-orange-600 px-4 py-2.5 text-xs font-black text-white hover:bg-orange-700 disabled:opacity-60 sm:rounded-xl sm:px-5 sm:text-sm"
          >
          ...
          <button
            ...
            className="rounded-lg border border-zinc-200 bg-white px-4 py-2.5 text-xs font-black text-zinc-700 hover:bg-zinc-50 sm:rounded-xl sm:px-5 sm:text-sm"
          >
