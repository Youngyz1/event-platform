...
const STATUS_CONFIG: Record<string, { label: string; color: string; dot: string }> = {
  verified: { label: "Active", color: "border-emerald-200 bg-emerald-50 text-emerald-700", dot: "bg-emerald-500" },
    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          ...
          className="inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-lg bg-orange-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-150 hover:bg-orange-700 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 sm:w-auto"
        >
                ...
                >
                  <div className="min-w-0 space-y-4">
                    ...
                    <div className="flex min-w-0 items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1 space-y-1.5">
                        <h3 className="min-w-0 break-words text-sm font-semibold leading-snug text-slate-900 transition group-hover:text-orange-600 line-clamp-2">
                          {org.name}
                        </h3>
                        <div className="flex flex-wrap items-center gap-1.5">
                          <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-orange-200 bg-orange-50 px-2.5 py-0.5 text-xs font-medium text-orange-700">
                  ...
                  <div className="mt-5 flex flex-col gap-2 border-t border-slate-100 pt-4 sm:flex-row">
                    <Link
                      ...
                      className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-lg bg-orange-600 py-2.5 text-xs font-semibold text-white shadow-sm transition-all duration-150 hover:bg-orange-700 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 sm:flex-1"
                    >
                      Enter Workspace
