 ...
 *                │
 *                ▼
 *       [FundraiserProvider]    ← v1 provider
 *                │
 *                ▼
 *          Supabase query
 *                │
 ...
 *   type:        string   — 'fundraiser' | 'business' | ...
 *   title:       string
...
// ── Fundraiser Provider ────────────────────────────────────────────────────────
/**
 * Fetches active fundraisers — campaigns where raised < goal (still
 * collecting donations). Returns up to CANDIDATE_POOL_SIZE records so the
 * engine can pick one at random.
 */
