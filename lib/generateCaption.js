...
const dailyTemplates = [
  ...
  "Behind every donation, every share, every message — there's a real story of impact.",
  ...
  "Giving isn't about how much — it's about showing up. Thank you for showing up.",
...
export async function generateContentCaption({ title, excerpt }) {
